...
const DoctorDashboard = () => {
  ...
  const [ ,setTime] = useState<Date>(new Date()); // Declare setTime
...
//     const tokenInterval = setInterval(fetchTokenNum, 30000);
//     const statusInterval = setInterval(fetchDoctorStatus, 30000);
...
//                         className="inline-block px-4 py-2 rounded-full bg-indigo-100 text-indigo-800 transition-all"
//                         style={{
