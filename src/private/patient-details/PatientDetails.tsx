...
//         // Format patient data like in old code
...
//             {[
//               { label: 'Address Type', content: ndata?.residenceType },
//               { label: 'Medical History', content: ndata?.medHis },
//               { label: 'Family History', content: ndata?.famHis },
//               { label: 'Allergies', content: ndata?.allergies },
//             ].map((item, index) => (
...
//                           <input
//                             type="number"
//                             className="rounded-md border p-2 bg-indigo-50 duration-${index} w-full"
//                             placeholder="0"
//                             min={1}
//                           />
//                         </td>
...
//               className="w-full py-6 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white shadow-lg rounded-xl"
//             >
//               Submit Prescription
//             </Button>
//             <Button
//               onClick={handleRelease}
//               className="w-full py-6 bg-gradient-to-r from-rose-500 to-rose-600 hover:from-rose-600 hover:to-rose-700 text-white shadow-lg rounded-xl"
//             >
//               Release Patient
//             </Button>
//           </motion.div>
...
const PatientDetails = () => {
  ...
  <PopoverContent className="max-w-sm p-2 bg-white rounded-xl shadow-lg border border-indigo-50">
    <div className="space-y-1">
      {['Dayscholar', 'In-Campus', 'Off-Campus'].map((type) => (
        <div
          key={type}
          className="p-2 hover:bg-indigo-50 rounded-lg cursor-pointer"
          onClick={() => {
            setNdata({...ndata, residenceType: type});
    ...
    .map((medicine: { id: string; medicineName: string; quantity: number }) => (
      ...
      >
        {medicine.medicineName} (Quantity: {medicine.quantity})
                                ...
                                {['Morning', 'Afternoon', 'Evening'].map((time) => (
                                  <td key={time} className="border p-2">
                                    <input
                                      ...
                                      min={0}
                                      step="0.5"
                                      className="rounded-md border p-2 bg-indigo-50 w-full"
                                      placeholder="0"
                                    />
                                  </td>
                                ))}
                        ...
                        <td className="border p-2">
                          <textarea className="rounded-md border p-2 bg-indigo-50 w-full" />
                        </td>
