    ...
    const fetchData = async () => {
      try {
        ...
        const apiUrl = role === "patient" 
          ? "http://ec2-13-201-227-93.ap-south-1.compute.amazonaws.com/api/patient/getAppointment"
          : `http://ec2-13-201-227-93.ap-south-1.compute.amazonaws.com/api/doctor/getAppointmentPat/${getPatientEmail()}`;
